...
export default function FlowCanvasPage({ params }: { params: Promise<{ companyId: string; flowId: string }> }) {
  const { companyId, flowId } = use(params);
  const flow = STANDARD_FLOW;
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 text-sm text-white/70">
          <Link href={`/dashboard/${companyId}/automations`} className="inline-flex items-center gap-1 hover:text-white">
        ...
        <div className="min-w-[1000px] grid grid-cols-[220px_80px_220px_80px_220px_80px_220px] gap-x-4 items-start">
          ...
          <div>
            <FlowNodeEmail
              ...
              onClick={() => { try { sessionStorage.setItem("draft_email_content", buildEmailHtml("welcome")); } catch {} }}
            />
          </div>
          <FlowEdge />
          <div>
          ...
          <div className="col-start-7 col-span-1 mt-24">
            <FlowNodeEmail
              ...
              onClick={() => { try { sessionStorage.setItem("draft_email_content", buildEmailHtml("nudge")); } catch {} }}
            />
          </div>
          <div className="col-start-7 col-span-1 mt-24">
